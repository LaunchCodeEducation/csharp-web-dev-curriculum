...
You can test this our in your `csharp-web-dev-examples` repo.  This example is in the Classes-Part-2 solution.
{{% /notice %}}
...
Inside the `csharp-web-dev-examples` repo you will find the following example in the `TemperatureExample` project.
